...
cat data/reads/SRR31761441_1.fastq.gz data/reads/SRR31761442_1.fastq.gz > data/reads/SRR31761441_merged_1.fastq.gz
cat data/reads/SRR31761441_2.fastq.gz data/reads/SRR31761442_2.fastq.gz > data/reads/SRR31761441_merged_2.fastq.gz