...
# top_10_de <- tt$table[1:10, ]
# Create a column for highlighting top 10 DE transcripts
tt$table$top10 <- ""
tt$table$top10[1:10] <- tt$table$transcript_id[1:10]
...
ggplot(tt$table, aes(x = logFC, y = -log10(FDR),  label = top5)) +
  ...
  # geom_text_repel(data = top_10_de,
